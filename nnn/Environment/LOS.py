...
def get_y_e_HE(ip,wp_k,wp_k_1):
    ...
    #############################
    lbp            = 2.902              # Length between perpendicular
...
def activate(ip,wpA,H):
    ...
    H       : History of the points already used [Quadrant,waypoint index,Goal]
    ...
    return HE,y_e, H, S_prp[H[0]][H[1]][2]
...
# HE,y_e, H  = activate([0,0,0,0,0,0],wpA,H)
# print(np.rad2deg(HE))
# Hs = []
# for i in range(50):
#     print(i)
